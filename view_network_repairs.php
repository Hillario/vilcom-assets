...
/**
 * view_network_repairs.php
 *
 * This file enables the admin to view all the network equipment repairs.
 * 
 * @author Hillary Chesaro
 */
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">VIEW NETWORK EQUIPMENT REPAIRS</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                                        <li class="breadcrumb-item active">View Network Equipment Repairs</li>
                                    </ol>
                                </div>
                    ...
                    <div class="alert alert-info" role="alert">
                        <strong>View</strong> and <b>Update</b> network equipment repairs
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Network Equipment Repairs</h5>
                                </div>
                                <div class="card-body">
