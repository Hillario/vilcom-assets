 ...
 * add_quote.php
 *
 * This file enables the staff to generate quotations.
 * 
 * @author Hillary Chesaro
 */
 ...
 if ($_SERVER["REQUEST_METHOD"] == "POST") {    
    ...
    if (isset($_POST['quote_date'])) $quote_date = $_POST['quote_date'];
    ...
    if (empty($_POST["quote_date"])) {
        $error[] = 'Please enter the quote date';
    }
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="alert alert-info" role="alert">
                        <strong>Seamlessly</strong> generate quotations
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-0">Add Quotation form</h4>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        ...
                                        <div class="mt-3">
                                                ...
                                                <div>                                                    
                                                    <input name="quote_date" type="date" class="form-control" id="quote_date">
                                                </div>
                                            </div>
                                ...
                                $queryPreviousInvoiceNumber="SELECT quote_number FROM quote ORDER BY quote_id DESC LIMIT 1";
                                $selectPreviousInvoiceNumber=$db->select($queryPreviousInvoiceNumber);
                                foreach($selectPreviousInvoiceNumber as $row)
                                {
                                    $lastInvoiceNumber=$row['quote_number'];
                                }
                            ...
                            $queryInvoices="SELECT * FROM quote WHERE user_id=$user_id ORDER BY quote_id DESC";
                            $selectInvoices=$db->select($queryInvoices); 
                            ?>

                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Your Quotes</h5>
                                </div>
                                <div class="card-body">
                                    <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-ordering="false">Quote Number</th>
                                                <th data-ordering="false">Quote Date</th>
                                  ...
                                  <td><?php echo $row['updated_at'];?></td>                                                                    
                                                ...
                                                <td>
                                                    ...
                                                    <form method="post" action="add_quote_item.php"><input type="hidden" name="myQuoteId"  value="<?php echo $row['quote_id'];?>">
