...
/**
 * view_incident.php --> Admin part
 *
 * This file enables admin to view and track incidents reported.
 * 
 * @author Hillary Chesaro
 */
 ...
 $selectQuery="SELECT * from equipment_incident as I, office_equipment as E WHERE I.equipment_id=E.equipment_id AND priority='High' ORDER BY I.updated_at DESC";
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">VIEW INCIDENTS</h4>
