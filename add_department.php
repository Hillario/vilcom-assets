            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="alert alert-info" role="alert">
                        <strong>Seamlessly</strong> add departments with ease
                    </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-6">                                                                              
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <div class="form-icon">
                                                        <input type="email" class="form-control form-control-icon" id="iconInput" placeholder="Enter department name">
