                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                  ...
                                  $userQuery="SELECT DISTINCT E.system_name FROM office_equipment AS E INNER JOIN equipment_incident AS I ON E.equipment_id = I.equipment_id WHERE E.user_id = $user_id;";
