...
/**
 * view_equipment_repair.php
 *
 * This file enables the admin to view all the office equipment repairs.
 * 
 * @author Hillary Chesaro
 */
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">VIEW OFFICE EQUIPMENT REPAIRS</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                                        <li class="breadcrumb-item active">View Office Equipment Repairs</li>
                                    </ol>
                                </div>
                    ...
                    <div class="alert alert-info" role="alert">
                        <strong>View</strong> and <b>Update</b> office equipment repairs
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Office Equipment Repairs</h5>
                                </div>
                                <div class="card-body">
