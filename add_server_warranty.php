...
/**
 * add_server_warranty.php
 *
 * This file enables the admin to add server equipment warranties.
 * 
 * @author Hillary Chesaro
 */
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">ADD SERVER EQUIPMENT WARRANTY</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                                        <li class="breadcrumb-item active">Add Server Equipment Warranty</li>
                                    </ol>
                                </div>
                    ...
                    <div class="alert alert-info" role="alert">
                        <strong>Seamlessly</strong> add server equipment warranty with ease
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-0">Add server equipment warranty form</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-lg-6">
                                        ...
                                        <div class="mt-3">
                                                <label class="form-label">Select Server Equipment</label>
                                                <div class="form-icon">
