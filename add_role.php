...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($_POST["item_name"])) {
        $error[] = 'Please enter the name of the role';
    }
    if (empty($_POST["description"])) {
        $error[] = 'Please enter description of the role';
    }
}
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="alert alert-info" role="alert">
                <strong>Seamlessly</strong> add roles
            </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <div class="form-icon">
                                                <input type="text" name="item_name" class="form-control form-control-icon" id="item_name" placeholder="Enter role name">
        ...
        <strong>Error Imminent! </strong>' . @implode('</li><li>', $error) . ' 
                                ...
                                $insertQuery = "INSERT INTO `role` (`role_id`, `name`, `description`, `updated_at`) VALUES (NULL, '".$item_name."', '".$description."', CURRENT_TIMESTAMP);";
