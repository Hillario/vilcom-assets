...
/**
 * view_request.php --> Staff part
 *
 * This file enables staff to view and track the equipment requested.
 * 
 * @author Hillary Chesaro
 */
 ...
 $selectQuery="SELECT * FROM request WHERE user_id=$user_id";
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">VIEW YOUR REQUESTS</h4>
