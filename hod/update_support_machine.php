...
/**
 * update_support_machine.php
 *
 * This file enables the admin to update support machines.
 * 
 * @author Hillary Chesaro
 */
 ...
 include "header.php";
  ...
  //Retrieve User ID
  if(isset($_POST['myMachineId']))
  {
      $_SESSION['machineid']=$_POST['myMachineId'];
  
  }
  
  $machineid=($_SESSION['machineid']);
  
  $requestQuery="SELECT * FROM support_machines WHERE support_machine_id=$machineid";
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">UPDATE SUPPORT MACHINE</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                                        <li class="breadcrumb-item active">Update Support Machine</li>
                                    </ol>
                                </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        ...
                                        <!-- Update button -->
            <div class="text-left">
                <button type="submit" name="update" class="btn btn-info">Update Machine</button>
            </div>

            <!-- Delete button -->
            <div class="text-left mt-2">
                <button type="submit" name="delete" class="btn btn-danger">Delete Machine</button>
            </div>
                                    </div>
                                </div>
                                </form>
                                ...
                                function calculateDepreciatedValue($purchaseCost, $purchaseDate, $depreciationRate) {
                                    ...
                                    return round($currentValue, 2);
										...
										<strong>Take Note! </strong>' . @implode('</li><li>', $error) . ' 
                                                                ...
                                                                $insertQuery = "UPDATE `support_machines` SET `asset_description`='".$asset_description."', `model`='".$model."', `acquisition_date`='".$acquisition_date."', `released_date`='".$released_date."', `cost`='".$cost."', `location`='".$location."', `status`='".$status."', `serial_no`='".$serial_no."', `insurance_info`='".$insurance_info."', `type`='".$type."', `insurance_expiry`='".$insurance_expiry."', `comments`='".$comments."', `current_value`='".$current_value."', `depreciation_rate`='".$depreciation_rate."', `user_id`='".$staff."', `department_id`='".$department."', `updated_at`= current_timestamp() WHERE `support_machines`.`support_machine_id` = '".$machineid."';";
                                                                $db->insert($insertQuery);
                                                                header('Location:view_support_machine.php');
                                                                echo '<div class="alert alert-info">										
										<strong>Success! </strong>Support machine has been updated
									</div>';
                                                            } 
                                                        }
                                                    }
                                                    ...
                                                    if (isset($_POST['delete'])) {
                                                        ...
                                                        $deleteQuery = "DELETE FROM `support_machines` WHERE `support_machine_id` = '$machineid'";
                                                        $db->insert($deleteQuery);
                                                        header('Location:view_support_machine.php');
                                                        echo '<div class="alert alert-danger"><strong>Success!</strong> Support machine has been deleted.</div>';
                                                    }
