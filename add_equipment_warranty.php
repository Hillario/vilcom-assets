 ...
 *
 * This file enables the admin to add warranty to office equipments.
 * 
 * @author Hillary Chesaro
 */
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="alert alert-info" role="alert">
                        <strong>Select</strong> and <b>Add</b> office equipment warranty information
                    </div>
...
<?php
                                  ...
                                  <td><?php echo $row['updated_at'];?></td>                                                                    
                                                ...
                                                <div class="dropdown d-inline-block">
                                                    <form method="post" action="add_warranty.php"><input type="hidden" name="WarrantyEquipmentId"  value="<?php echo $row['equipment_id'];?>">
                                                        <button name="add_items" id="add_items" class="btn btn-info" type="submit">
                                                        <i class="ri-verified-badge-line align-bottom me-1"></i>Add Warranty
                                                        </button>
                                                    </form>
                                                    </div>
                                                </td>
