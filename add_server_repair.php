...
/**
 * add_server_repair.php
 *
 * This file enables the admin to add server equipment repairs.
 * 
 * @author Hillary Chesaro
 */
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">ADD SERVER EQUIPMENT REPAIR</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                                        <li class="breadcrumb-item active">Add Server Equipment Repair</li>
                                    </ol>
                                </div>
                    ...
                    <div class="alert alert-info" role="alert">
                        <strong>Seamlessly</strong> add server equipment repair with ease
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-0">Add server equipment repair form</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-lg-6">                                             
