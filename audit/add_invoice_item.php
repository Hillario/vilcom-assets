        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    $queryInvoiceNumber="SELECT invoice_number,discount,total_amount,tax from invoice WHERE invoice_id=$invoiceid";
                                ...
                                $newItemNumber=generateItemNumber($lastItemNumber);
										...
										<strong>Take Note! </strong>' . @implode('</li><li>', $error) . ' 
                                                            ...
                                                            $localTotalDiscount=$discount*$quantity;    
                                                                ...
                                                                $insertQuery = "INSERT INTO `invoice_item` (`invoice_item_id`, `item_number`, `item_name`, `description`, `quantity`, `unit_price`, `discount`, `amount`, `invoice_id`, `updated_at`) VALUES (NULL, '".$newItemNumber."', '".$item_name."', '".$description."', '".$quantity."', '".$unit_price."', '".$localTotalDiscount."', '".$localTotalAmount."', '".$invoiceid."', CURRENT_TIMESTAMP);";
                                                                ...
                                                                $updateQuery="UPDATE `invoice` SET `discount` = '".$finalDiscount."', `total_amount` = '".$finalTotalAmount."', `tax` = '".$taxAmount."', `grand_total` = '".$grandTotal."' WHERE `invoice`.`invoice_id` = '".$invoiceid."';";
